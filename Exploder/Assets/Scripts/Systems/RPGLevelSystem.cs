...
namespace MunizCodeKit.Systems
{
    public class RPGLevelSystem
    {
        ...
        public void AddExperience(int value)
        {
            ...
            {
                experiencePointsSystem.AddValue(value);
                return;
            ...
            experiencePointsSystem.AddValue(aux);
        }
        ...
        public void AddLevel(int value)
        {
            ...
            {
                levelPointsSystem.AddValue(value);
            }
            else
            {
                levelPointsSystem.ResetPoints();
                levelPointsSystem.AddValue(levelPointsSystem.maxPoints);
            }
        }
